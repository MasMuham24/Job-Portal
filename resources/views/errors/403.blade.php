...
@section('title', '403 - Akses Ditolak - Job Portal')

@section('content')
<div class="min-h-[65vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-16">
    <div class="max-w-md w-full text-center">
        <div class="w-20 h-20 mx-auto mb-6 rounded-3xl bg-red-50 text-red-600 flex items-center justify-center shadow-xs border border-red-100">
            <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
            </svg>
        </div>
        <span class="inline-block px-3 py-1 text-xs font-bold rounded-full bg-red-100 text-red-700 tracking-wider uppercase mb-3">
            Error 403
        </span>
        ...
        <p class="text-sm text-slate-600 mb-8 leading-relaxed">
            Maaf, Anda tidak memiliki izin atau hak akses untuk membuka halaman ini. Silakan periksa kembali akun atau kembali ke halaman utama.
        </p>
