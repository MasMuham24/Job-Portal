...
@section('title', 'Tambah Pengguna - Admin - Job Portal')
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    {{-- Header --}}
    <div class="mb-8">
        <h1 class="text-2xl font-extrabold text-slate-900">Tambah Pengguna Baru</h1>
        <p class="mt-1 text-sm text-slate-500">Buat akun pengguna baru untuk Job Portal.</p>
    </div>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-8">
            ...
            <div>
                <div class="border-b border-slate-100 pb-3 mb-6">
                    ...
                    <p class="text-xs text-slate-500">Data dasar akun pengguna baru.</p>
                </div>
            ...
            <div>
                ...
                <div>
                    ...
                    <select name="role"
                        ...
                        <option value="employer" {{ old('role') === 'employer' ? 'selected' : '' }}>Rekruter (Employer)</option>
